      ...
      <div className="p-10  text-center">
        ...
        <div className="flex flex-col gap-4 text-start max-w-xl mx-auto mb-20">
          ...
          <p>
            ...
            work environments. I'm the type who loves learning new stuff, and
            I've got a knack for picking things up fast. Whether it's a new
            skill, tool, or a completely different job, I'm up for the
            adventure.
          </p>
          <p>
            Let's not just work - let's make things happen together. If you've
            got a project or idea in mind, I'm all ears. Let's connect and
            explore the possibilities. I'm not just a worker, I'm a proactive
            problem solver and a dedicated team player.
          </p>
          <p>
            I'm excited about the opportunities to collaborate, innovate, and
            make a meaningful impact in my field. Let's connect and explore how
            my skills and motivation can contribute to our shared goals.
          </p>
